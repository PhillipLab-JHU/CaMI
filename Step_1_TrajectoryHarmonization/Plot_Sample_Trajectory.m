...
figure;
HT1080_2D_2min = [];
[HT1080_2D_2min]=get_nonMultiples(data,2,239,2,1); %data points every 2 min = Original Trajectory which has N=239 timepoints | dt_needed=dt_actual=2min
clear x; clear y;
...
HT1080_2D_4min = [];
[HT1080_2D_4min]=get_nonMultiples(data,2,239,4,1); %data points every 4 min. Original Trajectory has N=239 timepoints | dt_needed=4min, dt_actual=2min
clear x; clear y;
...
HT1080_2D_5min = [];
[HT1080_2D_5min]=get_nonMultiples(data,2,239,5,1); %data points every 5 min. Original Trajectory has N=239 timepoints | dt_needed=5min, dt_actual=2min
clear x; clear y;
